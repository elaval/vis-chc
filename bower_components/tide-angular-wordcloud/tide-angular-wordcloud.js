      ...
      link: function (scope, element, attrs) {
        ...
        var render = function(data) {
          if (data && data.length) {
            ...
            var prealocatedwords = _.filter(data, function(d) {return d.x && d.y})

            var tags = svgContainer.selectAll("text")
                .data(prealocatedwords, function(d) {
                  return d.text
                })
            ...
            var drawWord = function(word) {
              ...
              var tags = svgContainer.selectAll("text")
                  .data(progressiveWords, function(d) {
                    return d.text
                  })
